...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/asf26/sub2api:0.1.155-subpilot.1
...
SUB2API_IMAGE=ghcr.io/asf26/sub2api:0.1.155-subpilot.1 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
